                ...
                <form action="{{ route('energy-breakdown-update') }}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" id="commerce" class="form-control" name="commerce" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="household" class="form-label">HouseHold</label>
                            <input type="text" id="household" class="form-control" name="household" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="transport" class="form-label">Transport</label>
                            <input type="text" id="transport" class="form-control" name="transport" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="others" class="form-label">Others</label>
                            <input type="text" id="others" class="form-control" name="others" required>
                        </div>
                ...
                <form action="{{ route('usage-breakdown-waste-discharges-update') }}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" id="commercial" class="form-control" name="commercial" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="domestic" class="form-label">Domestic</label>
                            <input type="text" id="domestic" class="form-control" name="domestic" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="agriculture" class="form-label">Agriculture</label>
                            <input type="text" id="agriculture" class="form-control" name="agriculture" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
